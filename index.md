...
>
> - <a rel="nofollow noopener" href="https://linkv.org/pia/" target="_blank">Private Internet Access</a>，简称PIA，老牌VPN，不少人也听说过。PIA成立于2010年，是<a rel="nofollow noopener" href="https://www.fastvpncn.com/expressvpn" target="_blank">ExpressVPN</a>母公司Kape Technologies的产品，但PIA性价比比Express略高，而且在国内使用被屏蔽的概率也略小于Express。目前也是我常用的一款VPN产品，在国内用着也不错，网络速度很快。支持App一键连接，在特殊时期可以找在线客服进行手动配置。支持内外网分流功能（Split Tunnel），连上VPN后，也可以使用本地网络访问国内网络资源，速度很快。支付方式支持外币信用卡（Visa/MasterCard等）、Paypal和加密货币，有条件的读者可以试试。
