...
<a rel="nofollow noopener" href="https://linkv.org/pia/" target="_blank">Private Internet Access</a>（**最近国庆期间挂了，客服说中国的连接目前无法恢复，近期慎选，貌似PIA用户都是老外**），简称PIA，老牌VPN，不少人也听说过。PIA成立于2010年，是ExpressVPN母公司Kape Technologies集团的产品，PIA性价比略高于Express，而且之前在国内使用被屏蔽的概率感觉也稍低于Express。目前也是我常用的一款VPN产品，在国内用着也不错，网络速度很快，被墙屏蔽频率较低。支持App一键连接，在特殊时期可以找在线客服进行手动配置。支持内外网分流功能（Split Tunnel），连上VPN后，也可以使用本地网络访问国内网络资源，访问国内APP和网站就很方便。支付方式可以使用信用卡（Visa/MasterCard等）、Paypal和加密货币，不支持支付宝或银联借记卡，30天试用期内可全额退款，有条件的读者可以试试。
